...
var ExampleGridBuilder = (function () {
    ...
    ExampleGridBuilder.prototype.createResourceRow = function (cells, line) {
        cells.push(new FlexCell_1.FlexCell(0, line + 1, null, "Horizontal #" + line));
        for (var i = 0; i < this.cols; i++) {
            var cell = new FlexCell_1.FlexCell(i + 1, line + 1);
...
},{"./../model/default/DefaultGrid":25,"./../model/flexi/FlexCell":27}],2:[function(require,module,exports){
"use strict";
...
var grid = GridElement_1.GridElement
    ...
    .extend(new HistoryModule_1.HistoryModule());
grid.model = model;
...
},{"../extensions/CopyPasteModule":3,"../extensions/EditingExtension":4,"../extensions/HistoryModule":5,"../extensions/ScrollerExtension":6,"../extensions/SelectorExtension":7,"../model/flexi/FlexGridBuilder":28,"../ui/GridElement":30,"./ExampleGridBuilder":1}],3:[function(require,module,exports){
"use strict";
...
var CopyPasteModule = (function () {
    function CopyPasteModule() {
        this.copyList = [];
        this.copyRange = GridRange_1.Range.empty();
    }
    ...
    CopyPasteModule.prototype.doCopy = function (cells, delimiter) {
        ...
        this.copyList = cells;
        var range = this.copyRange = GridRange_1.Range.create(this.grid.model, cells);
        var text = '';
        if (!cells.length)
            return;
    ...
    CopyPasteModule.prototype.doPaste = function (text) {
        ...
        var pasteRange = GridRange_1.Range.select(grid.model, startVector, endVector);
        var changes = {};
...
},{"../geom/Point":8,"../geom/Rect":9,"../input/KeyInput":12,"../misc/Dom":17,"../misc/Util":19,"../model/GridRange":22,"../ui/Extensibility":29,"../ui/Widget":33,"../vendor/clipboard":37,"papaparse":39,"tether":51}],4:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../geom/Point":8,"../input/KeyInput":12,"../input/MouseInput":16,"../misc/Dom":17,"../misc/Util":19,"../ui/Extensibility":29,"../ui/Widget":33,"tether":51}],5:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HistoryModule = (function () {
    ...
    HistoryModule.prototype.init = function (grid, kernel) {
        var _this = this;
        this.grid = grid;
        KeyInput_1.KeyInput.for(grid.root)
    ...
    Object.defineProperty(HistoryModule.prototype, "index", {
        get: function () {
            return this.grid.kernel.variables.get('modelIndex');
        },
        enumerable: true,
    ...
    HistoryModule.prototype.undo = function () {
        if (!this.past.length) {
            return;
        }
    ...
    HistoryModule.prototype.redo = function () {
    ...
    HistoryModule.prototype.push = function (action) {
        this.past.push(action);
        this.future = [];
    };
    HistoryModule.prototype.beforeCommit = function (changes) {
        if (this.noCapture)
            return;
    ...
    HistoryModule.prototype.createSnapshots = function (changes) {
    ...
    HistoryModule.prototype.createEditAction = function (snapshots) {
        var _this = this;
        return {
            apply: function () {
    ...
    HistoryModule.prototype.invokeSilentCommit = function (changes) {
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], HistoryModule.prototype, "undo", null);
__decorate([
    Extensibility_1.command(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], HistoryModule.prototype, "redo", null);
__decorate([
    Extensibility_1.command(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], HistoryModule.prototype, "push", null);
exports.HistoryModule = HistoryModule;

},{"../input/KeyInput":12,"../misc/Util":19,"../ui/Extensibility":29}],6:[function(require,module,exports){
"use strict";
var Tether = require("tether");
var Dom = require("../misc/Dom");
...
},{"../misc/Dom":17,"tether":51}],7:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../geom/Point":8,"../geom/Rect":9,"../input/KeyInput":12,"../input/MouseDragEventSupport":14,"../input/MouseInput":16,"../misc/Dom":17,"../ui/Extensibility":29,"../ui/Widget":33,"tether":51}],8:[function(require,module,exports){
"use strict";
var Point = (function () {
    function Point(x, y) {
        this.x = 0;
...
},{"../misc/Util":19}],11:[function(require,module,exports){
"use strict";
...
},{"./EventTargetEventEmitterAdapter":10,"./KeyExpression":11}],13:[function(require,module,exports){
"use strict";
var Keys = (function () {
    function Keys() {
    }
...
},{"../geom/Point":8}],15:[function(require,module,exports){
"use strict";
var Keys_1 = require("./Keys");
var _ = require("../misc/Util");
...
},{"../misc/Util":19,"./Keys":13}],16:[function(require,module,exports){
"use strict";
var EventTargetEventEmitterAdapter_1 = require("./EventTargetEventEmitterAdapter");
...
},{"./EventTargetEventEmitterAdapter":10,"./MouseExpression":15}],17:[function(require,module,exports){
"use strict";
function parse(html) {
...
},{"../misc/Util":19}],22:[function(require,module,exports){
"use strict";
...
var Range = (function () {
    ...
    Range.select = function (model, from, to, toInclusive) {
        if (toInclusive === void 0) { toInclusive = false; }
        if (toInclusive) {
            to = to.add(1);
        }
        var index = new GridModelIndex_1.GridModelIndex(model);
...
},{"../geom/Rect":9,"../misc/util":20,"./GridModelIndex":21}],23:[function(require,module,exports){
"use strict";
...
},{"shortid":42}],24:[function(require,module,exports){
"use strict";
...
},{"../../ui/Renderer":32,"../default/DefaultCell":23}],28:[function(require,module,exports){
"use strict";
...
},{"../default/DefaultGrid":25,"./FlexCell":27}],29:[function(require,module,exports){
"use strict";
/**
...
},{"../geom/Point":8,"../geom/Rect":9,"../misc/Property":18,"./../model/GridModelIndex":21,"./../model/default/DefaultGrid":25,"./GridKernel":31,"./internal/DefaultCellVisual":34,"./internal/EventEmitter":35,"./internal/GridLayout":36}],31:[function(require,module,exports){
"use strict";
/**
...
},{"../geom/Rect":9,"../misc/Dom":17}],34:[function(require,module,exports){
"use strict";
...
},{"../../geom/Rect":9,"../../misc/Util":19,"../../model/default/DefaultColumn":24,"../../model/default/DefaultRow":26}],37:[function(require,module,exports){
/**
...
},{"es6-promise":38}],38:[function(require,module,exports){
...
},{"./lib/index":46}],43:[function(require,module,exports){
'use strict';
...
},{"./random/random-from-seed":49}],44:[function(require,module,exports){
'use strict';
...
},{"./alphabet":43}],45:[function(require,module,exports){
'use strict';
...
},{"./random/random-byte":48}],46:[function(require,module,exports){
'use strict';
...
},{"./alphabet":43,"./decode":44,"./encode":45,"./is-valid":47,"./util/cluster-worker-id":50}],47:[function(require,module,exports){
'use strict';
var alphabet = require('./alphabet');
...
},{"./alphabet":43}],48:[function(require,module,exports){
'use strict';
