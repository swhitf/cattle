...
var Rect = /** @class */ (function () {
    ...
    Rect.prototype.points = function () {
        return [
            ...
            new Point_1.Point(this.left + this.width, this.top),
            new Point_1.Point(this.left + this.width, this.top + this.height),
            new Point_1.Point(this.left, this.top + this.height),
        ];
    };
    ...
    Rect.prototype.equals = function (another) {
        if (!another)
            return false;
        return ((this == another) ||
