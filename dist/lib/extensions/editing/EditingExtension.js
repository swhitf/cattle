...
var GridChangeEvent_1 = require("./GridChangeEvent");
...
var EditingExtension = /** @class */ (function () {
    ...
    EditingExtension.prototype.init = function (grid, kernel) {
        ...
        KeyBehavior_1.KeyBehavior.for(grid.surface)
            ...
            .on('*.PRESS', function (e) { return !!e.char ? _this.doBeginEdit(e.char) : false; }); });
    ...
    EditingExtension.prototype.doCommit = function (changes) {
        ...
        if (changes.length) {
            grid.emit(new GridChangeEvent_1.GridChangeEvent(changes));
            if (autoApply) {
