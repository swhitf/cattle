...
var EditingExtension = /** @class */ (function (_super) {
    ...
    EditingExtension.prototype.init = function (grid, kernel) {
        ...
        MouseBehavior_1.MouseBehavior.for(this.inputHandle.elmt)
            .on(['LEFT', 'MIDDLE', 'RIGHT'], function () { return _this.state = State.EditingPrecise; });
        KeyBehavior_1.KeyBehavior.for(this.inputHandle.elmt)
        ...
        kernel.variables.define('editInput', { get: function () { return _this.inputHandle.elmt; } });
    };
    ...
    EditingExtension.prototype.doBeginEdit = function (override) {
        var _a = this, grid = _a.grid, inputHandle = _a.inputHandle, primarySelection = _a.primarySelection;
